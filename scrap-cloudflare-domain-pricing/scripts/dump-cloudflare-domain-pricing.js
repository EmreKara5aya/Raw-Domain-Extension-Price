...
async function mainScript(config = {}) {
    ...
    let defaultConfig = {
      tldList: ["academy","accountant","accountants","actor","agency","apartments","associates","attorney","auction","band","bar","bargains","beer","bet","bid","bike","bingo","biz","black","blog","blue","boston","boutique","broker","builders","business","cab","cafe","camera","camp","capital","cards","care","careers","casa","cash","casino","catering","cc","center","ceo","chat","cheap","church","city","claims","cleaning","clinic","clothing","cloud","club","co","coach","codes","coffee","college","com","com.co","community","company","compare","computer","condos","construction","consulting","contact","contractors","cooking","cool","co.uk","coupons","credit","creditcard","cricket","cruises","dance","date","dating","deals","degree","delivery","democrat","dental","dentist","design","diamonds","digital","direct","directory","discount","doctor","dog","domains","download","education","email","energy","engineer","engineering","enterprises","equipment","estate","events","exchange","expert","express","fail","faith","family","fans","farm","fashion","finance","financial","fish","fishing","fit","fitness","flights","florist","fm","football","forex","forsale","foundation","fun","fund","furniture","futbol","fyi","gallery","games","garden","gifts","gives","glass","gmbh","gold","golf","graphics","gratis","green","gripe","group","guide","guru","haus","health","healthcare","hockey","holdings","holiday","horse","hospital","host","house","immo","immobilien","industries","info","ink","institute","insure","international","investments","io","irish","jetzt","jewelry","kaufen","kim","kitchen","land","lawyer","lease","legal","lgbt","life","lighting","limited","limo","live","loan","loans","love","ltd","luxe","maison","management","market","marketing","markets","mba",".me","media","memorial","men","me.uk","miami","mobi","moda","money","mortgage","movie","net","net.co","network","news","ninja","nom.co","observer","online","org","org.uk","partners","parts","party","pet","photography","photos","pictures","pink","pizza","place","plumbing","plus","press","pro","productions","promo","properties","pub","racing","radio.fm","realty","recipes","red","rehab","reise","reisen","rent","rentals","repair","report","republican","rest","restaurant","review","reviews","rip","rocks","rodeo","run","sale","salon","sarl","school","schule","science","security","select","services","shoes","shopping","show","singles","site","soccer","social","software","solar","solutions","space","storage","store","stream","studio","style","supplies","supply","support","surf","surgery","systems","tax","taxi","team","tech","technology","tennis","theater","theatre","tienda","tips","tires","today","tools","tours","town","toys","trade","trading","training","tv","uk","university","us","vacations","ventures","vet","viajes","video","villas","vin","vip","vision","vodka","voyage","watch","webcam","website","wedding","wiki","win","wine","work","works","world","wtf","xyz","yoga","zone"],
    ...
    let tldsPricing = tldsDetail.map((tld, idx) => {
      let tldNameParts = tld.name.split('.');
      let tldPricing = {
        tld_name: tldNameParts.slice(1).join('.'),
